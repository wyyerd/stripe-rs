...
use crate::resources::{Address, BillingDetails, Card, Charge, Customer};
...
pub struct PaymentMethodCardGeneratedCard {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub setup_attempt: Option<()>,
}

#[derive(Clone, Debug, Deserialize, Serialize)]
pub struct CardGeneratedFromPaymentMethodDetails {
    // TODO: Is this the right Card type to use?
    #[serde(skip_serializing_if = "Option::is_none")]
    pub card_present: Option<Card>,
